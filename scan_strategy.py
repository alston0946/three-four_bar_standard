...
OUTPUT_DIR_BASE = REPO_ROOT / "outputs" / "local_run"
OUTPUT_DIR_BASE.mkdir(parents=True, exist_ok=True)


def _default_target_dates():
    env_target = os.environ.get("TARGET_DATE")
    if env_target:
        return [env_target]
...
CODE_FILE = os.environ.get("CODE_FILE", str(DATA_DIR / "a_share_codes_for_akshare.csv"))
BELOW_8B_FILE = os.environ.get("BELOW_8B_FILE", str(DATA_DIR / "a_share_below_8b.csv"))
ST_FILE = os.environ.get("ST_FILE", str(DATA_DIR / "st_stocks.csv"))

OUTPUT_FILE = os.environ.get("OUTPUT_FILE", str(OUTPUT_DIR_BASE / "three_bar_play_resting_candidates.csv"))
DEBUG_FILE = os.environ.get("DEBUG_FILE", str(OUTPUT_DIR_BASE / "three_bar_play_resting_debug.csv"))
FAILED_FILE = os.environ.get("FAILED_FILE", str(OUTPUT_DIR_BASE / "three_bar_play_resting_failed.csv"))
FILTERED_FILE = os.environ.get("FILTERED_FILE", str(OUTPUT_DIR_BASE / "three_bar_play_resting_filtered.csv"))
...
# 日期控制：多日期
# =========================
TARGET_DATES = _default_target_dates()
...
TEST_LIMIT = int(os.environ["TEST_LIMIT"]) if os.environ.get("TEST_LIMIT") else None
BATCH_START = int(os.environ.get("BATCH_START", "0"))
BATCH_SIZE = int(os.environ.get("BATCH_SIZE", "10000"))
SLEEP_SEC = float(os.environ.get("SLEEP_SEC", "0.10"))
...
RESTING_BARS_MIN = 1
RESTING_BARS_MAX = 4
PULLBACK_BAR_RANGE_RATIO_MAX = 0.50
